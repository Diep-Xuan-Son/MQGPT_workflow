...
supported_bm42_models = [
    ...
    {
        "model": "./weights/all_miniLM_L6_v2_with_attentions",
        "vocab_size": 30522,
        "description": "Light sparse embedding model, which assigns an importance score to each token in the text",
        "size_in_GB": 0.09,
        "sources": {
    ...
    {
        "model": f"{ROOT2}/weights/all_miniLM_L6_v2_with_attentions",
        "vocab_size": 30522,
        "description": "Light sparse embedding model, which assigns an importance score to each token in the text",
        "size_in_GB": 0.09,
        "sources": {
...
MODEL_TO_LANGUAGE = {
    ...
    "./weights/all_miniLM_L6_v2_with_attentions": "english",
    f"{ROOT2}/weights/all_miniLM_L6_v2_with_attentions": "english",
}
